...
export function rpsReducers(state = {
    ...
    var winner = (action.payload=='player1') ? whoWin(played,state.player2) : whoWin(state.player1,played);

    if(winner===null){
        return(action.payload=='player1') ?  {...state, player1:played, played1:played } :  {...state, player2:played, played2:played };
    }else{
